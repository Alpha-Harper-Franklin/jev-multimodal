...
后续已扩展到 [500 图、三种 COCO POPE 难度和普通批量推理对照](../benchmarks/pope500-all/README.md)，并补充多图 Score、真实 PDF/ASR/OCR 与来源冲突集成。这些仍是工程基线与小型集成验证；尚不能支持顶会新颖性、跨模态泛化或控制成功率结论。具体研究门槛见 [研究协议](RESEARCH_PROTOCOL.md)。
